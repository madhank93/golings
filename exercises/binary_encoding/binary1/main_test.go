...
func DecodeHeader(r io.Reader) (Header, error) {
	...
	// FIXME: fill buf from r — all of it, or report that it was short — then
	// decode the six fields out of it. Each is two bytes, in order.
	_ = io.ReadFull
	return Header{
...
func EncodeHeader(h Header) []byte {
	...
	// FIXME: the other five fields, in the same order and the same endianness.
	return buf
}
