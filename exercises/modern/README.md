...
- [Go 1.22: range over int](https://go.dev/doc/go1.22#language)
- [Go blog: Range Over Function Types](https://go.dev/blog/range-functions) · [iter package](https://pkg.go.dev/iter)
